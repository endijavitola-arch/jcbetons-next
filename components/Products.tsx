    ...
    <section className="py-20 bg-[#F5F4F0]" id="produkti">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {products.map((p) => (
            <article key={p.tag} className="bg-white rounded-xl overflow-hidden shadow-sm border border-black/5 flex flex-col">
              <div className="relative h-52 overflow-hidden">
                ...
                />
                <span
                  className="absolute top-3 left-3 bg-[#0F1115]/80 text-white/70 text-xs px-2 py-1 rounded font-mono"
              ...
              <div className="p-6 flex flex-col flex-1">
                <h3 className="font-bold text-[#0F1115] text-lg mb-2" style={{ fontFamily: "var(--font-archivo)" }}>
                  {p.title}
                </h3>
                ...
                <Link
                  href={p.cta.href}
                  className="inline-flex items-center gap-1.5 text-[#EE7E1A] font-semibold text-sm hover:gap-3 transition-all"
                >
                  {p.cta.label}
                  <ArrowIcon />
                </Link>
