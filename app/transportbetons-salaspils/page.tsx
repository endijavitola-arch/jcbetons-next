...
export const metadata: Metadata = {
  title: "Transportbetons Salaspilī | Betona Piegāde Salaspils Novadā | JC Betons",
  description:
    "Transportbetons ar piegādi Salaspilī un Salaspils novadā. Sertificēta betona ražotne Rīgā. C16/20–C30/37. Minimālais pasūtījums 5 m³. Zvaniet: +371 24 209 209",
  alternates: { canonical: "/transportbetons-salaspils" },
  openGraph: {
    title: "Transportbetons Salaspilī | JC Betons",
    description: "Betona piegāde Salaspils novadā no sertificētas ražotnes Rīgā. C16/20–C30/37, fibrobetons, piegāde ar pašu autofloti.",
    url: "https://jcbetons.lv/transportbetons-salaspils",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Transportbetons Salaspilī", item: "https://jcbetons.lv/transportbetons-salaspils" },
  ],
};
...
const localSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Transportbetons Salaspilī",
  provider: { "@type": "Organization", name: "JC Betons", url: "https://jcbetons.lv" },
  areaServed: { "@type": "AdministrativeArea", name: "Salaspils novads" },
  description: "Transportbetona piegāde Salaspils novadā no sertificētas ražotnes Rīgā.",
};

export default function SalaspilsPage() {
  return (
    <>
        ...
        <section className="pt-32 pb-20 bg-[#0F1115]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <nav className="text-sm text-white/40 mb-6 flex items-center gap-2">
              ...
              <span>/</span>
              <span className="text-white/70">Transportbetons Salaspilī</span>
            </nav>
            <div className="inline-flex items-center gap-2 text-xs font-mono text-[#EE7E1A] mb-6 border border-[#EE7E1A]/30 rounded-full px-4 py-1.5" style={{ fontFamily: "var(--font-jetbrains)" }}>
              ...
              Piegāde Salaspils novadā
            </div>
            <h1 className="text-5xl sm:text-6xl font-black text-white leading-tight mb-6" style={{ fontFamily: "var(--font-archivo)" }}>
              Transportbetons<br />
              <span className="text-[#EE7E1A]">Salaspilī.</span>
            </h1>
            <p className="text-white/60 text-xl max-w-xl mb-8">
              Betona piegāde Salaspilī, Sauleskalā un visā Salaspils novadā. Aptuveni 15–20 km no mūsu ražotnes Rīgā.
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <div>
                <h2 className="text-3xl font-black text-[#0F1115] mb-6" style={{ fontFamily: "var(--font-archivo)" }}>
                  Betona piegāde Salaspils novadā
                </h2>
                <p className="text-[#0F1115]/70 leading-relaxed mb-4">
                  Salaspils atrodas tieši uz Daugavas otras puses no Rīgas — mūsu autobetonmaisītāji regulāri piegādā betonu gan privātmāju celtniecībai, gan rūpnieciskiem objektiem Salaspilī un apkārtējos pagastos.
                </p>
                <p className="text-[#0F1115]/70 leading-relaxed mb-6">
                  Piegādājam arī Sauleskalnā, Daugmales pagastā un netālajās Stopiņu apkaimēs.
                </p>
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl border border-black/10 p-6">
                  <h3 className="font-black text-[#0F1115] mb-4 text-lg" style={{ fontFamily: "var(--font-archivo)" }}>
                    Populārākās klases Salaspilī
                  </h3>
                  <div className="space-y-3">
                    {[
                      { cls: "C16/20", use: "Lentveida pamati un mazas konstrukcijas" },
                      { cls: "C20/25", use: "Privātmājas pamati, starpstāvu pārsegumi" },
                      { cls: "C25/30", use: "Pamatplātne, ārtelpu plātnes, terasas" },
                    ].map(({ cls, use }) => (
