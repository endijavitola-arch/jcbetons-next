...
export const metadata: Metadata = {
  title: "Transportbetons Mārupē | Betona Piegāde Mārupes Novadā | JC Betons",
  description:
    "Transportbetons ar piegādi Mārupē, Jaunmārupē un Mārupes novadā. Sertificēta betona ražotne Rīgā. C20/25–C30/37. Zvaniet: +371 24 209 209",
  alternates: { canonical: "/transportbetons-marupe" },
  openGraph: {
    title: "Transportbetons Mārupē | JC Betons",
    description: "Betona piegāde Mārupes novadā no sertificētas ražotnes Rīgā. C20/25–C30/37, fibrobetons, piegāde ar pašu autofloti.",
    url: "https://jcbetons.lv/transportbetons-marupe",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Transportbetons Mārupē", item: "https://jcbetons.lv/transportbetons-marupe" },
  ],
};
...
const localSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Transportbetons Mārupē",
  provider: { "@type": "Organization", name: "JC Betons", url: "https://jcbetons.lv" },
  areaServed: { "@type": "AdministrativeArea", name: "Mārupes novads" },
  description: "Transportbetona piegāde Mārupes novadā no sertificētas ražotnes Rīgā.",
};

export default function MarupePage() {
  return (
    <>
        ...
        <section className="pt-32 pb-20 bg-[#0F1115]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <nav className="text-sm text-white/40 mb-6 flex items-center gap-2">
              ...
              <span>/</span>
              <span className="text-white/70">Transportbetons Mārupē</span>
            </nav>
            <div className="inline-flex items-center gap-2 text-xs font-mono text-[#EE7E1A] mb-6 border border-[#EE7E1A]/30 rounded-full px-4 py-1.5" style={{ fontFamily: "var(--font-jetbrains)" }}>
              ...
              Piegāde Mārupes novadā
            </div>
            <h1 className="text-5xl sm:text-6xl font-black text-white leading-tight mb-6" style={{ fontFamily: "var(--font-archivo)" }}>
              Transportbetons<br />
              <span className="text-[#EE7E1A]">Mārupē.</span>
            </h1>
            <p className="text-white/60 text-xl max-w-xl mb-8">
              Betona piegāde Mārupē, Jaunmārupē, Pinķos un visā Mārupes novadā. Viens no pieprasītākajiem rajoniem Pierīgā.
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <div>
                <h2 className="text-3xl font-black text-[#0F1115] mb-6" style={{ fontFamily: "var(--font-archivo)" }}>
                  Betona piegāde Mārupes novadā
                </h2>
                <p className="text-[#0F1115]/70 leading-relaxed mb-4">
                  Mārupes novads ir dinamiskākais apbūves rajons Pierīgā — jauni kvartāli, biroju parki un loģistikas centri. JC Betons regulāri apkalpo gan privātmāju celtniekus Jaunmārupē, gan lielus rūpnieciskus objektus ar lielu betona apjomu.
                </p>
                <p className="text-[#0F1115]/70 leading-relaxed mb-6">
                  No mūsu ražotnes Rīgā līdz Mārupes centrālajai daļai — aptuveni 15–20 minūtes. Piegādājam arī Pinķos, Skultes ciemā un netālajos Babītes novados.
                </p>
                <ul className="space-y-3">
                  {[
                    "Betona klases C8/10 līdz C35/45",
                    "Fibrobetons rūpnieciskiem objektiem un loģistikai",
                    "Lieli apjomi — vienojamies par cenu individuāli",
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl border border-black/10 p-6">
                  <h3 className="font-black text-[#0F1115] mb-4 text-lg" style={{ fontFamily: "var(--font-archivo)" }}>
                    Populārākās klases Mārupē
                  </h3>
                  <div className="space-y-3">
                    {[
                      { cls: "C25/30", use: "Privātmājas pamatplātne ar PP fibrām" },
                      { cls: "C30/37 fibro", use: "Biroju un loģistikas centru grīdas" },
                      { cls: "C20/25", use: "Starpstāvu pārsegumi, kāpnes" },
                    ].map(({ cls, use }) => (
