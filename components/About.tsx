      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-[#0F1115]/65 leading-relaxed mb-8">
            Ražojam uz <strong className="text-[#0F1115]">LIEBHERR LCM 1.0</strong> betona rūpnīcas — Vācijas iekārtas, kas tur recepti precīzi katrā partijā. Kvalitāti regulāri pārbauda neatkarīga institūcija <strong className="text-[#0F1115]">Kiwa INSPECTA Latvia</strong>, sertifikāts Nr. 3528.
          </p>
          <ul className="grid sm:grid-cols-2 gap-3">
            {whyList.map((item) => (
              <li key={item} className="flex items-center gap-2.5 text-sm text-[#0F1115]/80">
