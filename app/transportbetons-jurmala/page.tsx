...
export const metadata: Metadata = {
  title: "Transportbetons Jūrmalā | Betona Piegāde Jūrmalā | JC Betons",
  description:
    "Transportbetons ar piegādi Jūrmalā — Majori, Dzintari, Dubulti, Bulduri. Sertificēta kvalitāte C20/25–C30/37. JC Betons, Rīga. Zvaniet: +371 24 209 209",
  alternates: { canonical: "/transportbetons-jurmala" },
  openGraph: {
    title: "Transportbetons Jūrmalā | JC Betons",
    description: "Betona piegāde Jūrmalā no sertificētas ražotnes Rīgā. C20/25–C30/37, fibrobetons, piegāde ar pašu autofloti.",
    url: "https://jcbetons.lv/transportbetons-jurmala",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Transportbetons Jūrmalā", item: "https://jcbetons.lv/transportbetons-jurmala" },
  ],
};
...
const localSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Transportbetons Jūrmalā",
  provider: { "@type": "Organization", name: "JC Betons", url: "https://jcbetons.lv" },
  areaServed: { "@type": "City", name: "Jūrmala" },
  description: "Transportbetona piegāde Jūrmalā no sertificētas ražotnes Rīgā.",
};

export default function JurmalaPage() {
  return (
    <>
        ...
        <section className="pt-32 pb-20 bg-[#0F1115]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <nav className="text-sm text-white/40 mb-6 flex items-center gap-2">
              ...
              <span>/</span>
              <span className="text-white/70">Transportbetons Jūrmalā</span>
            </nav>
            ...
            <h1 className="text-5xl sm:text-6xl font-black text-white leading-tight mb-6" style={{ fontFamily: "var(--font-archivo)" }}>
              Transportbetons<br />
              <span className="text-[#EE7E1A]">Jūrmalā.</span>
            </h1>
            <p className="text-white/60 text-xl max-w-xl mb-8">
              Betona piegāde Jūrmalā — Majori, Dzintari, Dubulti, Bulduri un citās apkaimēs. Piegāde pēc vienošanās.
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <div>
                <h2 className="text-3xl font-black text-[#0F1115] mb-6" style={{ fontFamily: "var(--font-archivo)" }}>
                  Betona piegāde Jūrmalā
                </h2>
                <p className="text-[#0F1115]/70 leading-relaxed mb-4">
                  JC Betons piegādā transportbetonu Jūrmalā privātmāju un komercēku celtniecībai. Jūrmala atrodas aptuveni 30–40 km no mūsu ražotnes Rīgā, piegāde tiek organizēta pēc vienošanās, ņemot vērā ceļa laiku un betona cietēšanas sākumu.
                </p>
                <p className="text-[#0F1115]/70 leading-relaxed mb-6">
                  Ņemot vērā Jūrmalas agresīvo jūras vidi, bieži ieteicams betona klases XF (sala izturīgums) un C25/30 vai augstāks. Konsultēsimies par piemērotāko risinājumu jūsu objektam.
                </p>
                <ul className="space-y-3">
                  {[
                    "Betona klases C8/10 līdz C35/45",
                    "Sala izturīgais betons (XF klase) ārtelpu darbiem",
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl border border-black/10 p-6">
                  <h3 className="font-black text-[#0F1115] mb-4 text-lg" style={{ fontFamily: "var(--font-archivo)" }}>
                    Ieteicamās klases Jūrmalas objektiem
                  </h3>
                  <div className="space-y-3">
                    {[
                      { cls: "C25/30 XF", use: "Ārtelpu plātnes, terasas, stāvvietas" },
                      { cls: "C20/25", use: "Privātmājas pamati, starpstāvu pārsegumi" },
                      { cls: "C30/37 fibro", use: "Garāžas grīda, noliktavas, smaga slodze" },
                    ].map(({ cls, use }) => (
