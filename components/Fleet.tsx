    ...
    <section className="py-20 bg-[#0F1115]" id="piegade">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          {fleet.map((f) => (
            <div
              ...
              className={`rounded-xl p-6 border ${
                f.featured
                  ? "bg-[#EE7E1A]/10 border-[#EE7E1A]/30"
                  : "bg-white/5 border-white/10"
              }`}
            >
              <div
                className={`text-4xl font-black mb-2 ${f.featured ? "text-[#EE7E1A]" : "text-white"}`}
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-t border-white/10 pt-8">
          ...
          <Link
            href="/#kontakti"
            className="flex-shrink-0 bg-[#EE7E1A] hover:bg-[#d06e14] text-white font-bold px-6 py-3 rounded transition-colors"
          >
            Pieprasīt cenu
          </Link>
        </div>
